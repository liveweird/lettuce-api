---
name: api-review
description: Validate an OpenAPI spec (default the lettuce contract) against api-guidelines/API-GUIDELINES.md — Spectral lint pass plus the LLM review checklist, reported per rule ID.
---
